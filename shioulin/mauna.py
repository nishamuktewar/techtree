...
# read in Mauna Loa Co2 data and set ds and y variables
mauna = pd.read_csv('/Users/shioulinsam/Documents/Data/Mauna.csv')
mauna['y'] = np.log(mauna['Interpolated'])
mauna['ds'] = mauna['Date']
...
ax.set_xlabel('Date')
ax.set_ylabel('Atmospheric Carbon Dioxide')
fig1.show()
fig_string = '/Users/shioulinsam/Documents/Figures/' + 'mauna' + 'forecast.png'
fig1.tight_layout()
...
fig2.show()
fig_string = '/Users/shioulinsam/Documents/Figures/' + 'mauna' + 'component.png'
fig2.tight_layout()
